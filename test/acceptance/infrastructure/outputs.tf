output "access_key_id" {
  ...
  value       = aws_iam_access_key.postgresql_test_user.id
}

output "database_url" {
  description = "Connection URI for the test database instance"
  value       = "postgresql://${local.username}@${aws_db_instance.postgresql_test.endpoint}/${aws_db_instance.postgresql_test.name}"
}
...
output "secret_access_key" {
  ...
  value       = aws_iam_access_key.postgresql_test_user.secret
}

output "security_group_id" {
  description = "ID of the security group to allow ingress to the test database instance"
  value       = aws_security_group.postgresql_test.id
}
